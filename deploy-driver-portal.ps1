# GitHub Pages Deployment Script for Driver Portal - Windows PowerShell
# This script builds and deploys the driver portal to GitHub Pages using the gh-pages branch

Write-Host "Starting GitHub Pages deployment for Driver Portal..." -ForegroundColor Green

# Get script directory and navigate to project root
$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Path
Set-Location $ScriptDir

# Change to driver portal directory
Set-Location "frontend\driver-portal"
...
Write-Host "Building driver portal for production..." -ForegroundColor Yellow
$env:NODE_ENV = "production"
$env:VITE_BASE_PATH = "/ECEG301/driver/"
...
if ($LASTEXITCODE -eq 0) {
    ...
    Write-Host "Deploying driver portal to gh-pages branch..." -ForegroundColor Yellow
    npm run deploy
    
    if ($LASTEXITCODE -eq 0) {
        Write-Host "Deployment successful!" -ForegroundColor Green
        Write-Host "Your driver portal will be available at: https://acherniske.github.io/ECEG301/driver/" -ForegroundColor Cyan
...
Write-Host "Driver Portal deployment script completed!" -ForegroundColor Green
